...
" Error
if exists("g:r_syntax_folding")
   syn region rRegion matchgroup=rGroup start=/(/  matchgroup=rGroup end=/)/ transparent contains=ALLBUT,rError,rBraceError,rCurlyError,rAssignment fold
   syn region rRegion matchgroup=rGroup start=/{/  matchgroup=rGroup end=/}/ transparent contains=ALLBUT,rError,rBraceError,rParenError fold
   syn region rRegion matchgroup=rGroup start=/\[/ matchgroup=rGroup end=/]/ transparent contains=ALLBUT,rError,rCurlyError,rParenError,rAssignment fold
 else
   syn region rRegion matchgroup=rGroup start=/(/  matchgroup=rGroup end=/)/ transparent contains=ALLBUT,rError,rBraceError,rCurlyError,rAssignment
   syn region rRegion matchgroup=rGroup start=/{/  matchgroup=rGroup end=/}/ transparent contains=ALLBUT,rError,rBraceError,rParenError
   syn region rRegion matchgroup=rGroup start=/\[/ matchgroup=rGroup end=/]/ transparent contains=ALLBUT,rError,rCurlyError,rParenError,rAssignment
endif
" 
"  syn match rError      "[)\]}]"
...
"syn region rRegion matchgroup=rGroup start=/(/ matchgroup=rGroup end=/)/ transparent contains=ALLBUT,rAssignment fold
...
" Link the R types to the standard ones
hi def link rArrow       Statement	
hi def link rAssignment  Statement	
